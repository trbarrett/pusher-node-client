...
(function() {
  ...
  PusherClient = (function(_super) {
    ...
    PusherClient.prototype.connect = function() {
      ...
      if (this.verbose) {
        console.log("trying connecting to pusher on - wss://ws.pusherapp.com:443/app/" + this.credentials.key + "?client=node-pusher-server&version=0.0.9&protocol=5&flash=false");
      }
